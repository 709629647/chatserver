...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::LoginResponse, errno_code_),
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\022\022\n\nerrno_code\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014\022\017\n\007"
  "success\030\003 \001(\0102M\n\016UserServiceRpc\022;\n\014Login"
  "Service\022\024.fixbug.LoginRequest\032\025.fixbug.L"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_test_2eproto = {
  &descriptor_table_test_2eproto_initialized, descriptor_table_protodef_test_2eproto, "test.proto", 225,
...
LoginResponse::LoginResponse(const LoginResponse& from)
  ...
  ::memcpy(&errno_code_, &from.errno_code_,
    static_cast<size_t>(reinterpret_cast<char*>(&success_) -
    reinterpret_cast<char*>(&errno_code_)) + sizeof(success_));
...
void LoginResponse::SharedCtor() {
  ...
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  ::memset(&errno_code_, 0, static_cast<size_t>(
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          errno_code_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      // bytes errmsg = 2;
...
::PROTOBUF_NAMESPACE_ID::uint8* LoginResponse::_InternalSerialize(
  ...
  if (this->errno_code() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteInt32ToArray(1, this->_internal_errno_code(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.LoginResponse)
  ...
  if (from.errno_code() != 0) {
    _internal_set_errno_code(from._internal_errno_code());
  }
  if (from.success() != 0) {
...
void LoginResponse::InternalSwap(LoginResponse* other) {
  ...
  errmsg_.Swap(&other->errmsg_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  swap(errno_code_, other->errno_code_);
...
void UserServiceRpc::LoginService(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::LoginRequest*,
                         ::fixbug::LoginResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method LoginService() not implemented.");
  done->Run();
}
...
void UserServiceRpc_Stub::LoginService(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
